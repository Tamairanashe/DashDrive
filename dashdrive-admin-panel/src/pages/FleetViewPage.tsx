...
const MOCK_DRIVERS: Driver[] = [
    { 
        ...
        level: 'Gold Elite',
        earningsPerDay: 85.50,
        posReviewRate: 98,
        successRate: 94,
        cancellationRate: 2,
        idleHourRate: 15,
        wallet: { pending: 150.00, withdrawn: 1240.50, withdrawable: 450.75, total: 1841.25 },
        vehicle: {
            brand: 'Honda', model: 'R15', category: 'Bike', ownerType: 'Owner driver',
            vin: '4456788', fuelType: 'Petrol', engine: 'R15Prime Cc', seats: 1,
            transmission: 'TRT', capacity: 1, expiry: '2026-01-07', docs: ['reg_doc.png']
        }
    },
    // ... rest of drivers would be similarly updated, usingJohn as the primary example
];
...
const MOCK_DEMAND_CLUSTERS = [
    { id: 'c1', lat: -17.8248, lng: 31.0530, radius: 1200, intensity: 0.6, label: 'High Demand' },
    { id: 'c2', lat: -17.7800, lng: 31.0000, radius: 800, intensity: 0.4, label: 'Moderate Demand' }
];

const MOCK_CUSTOMERS: Customer[] = [
    { 
        id: 'UP-001', lat: -17.825, lng: 31.052, name: 'Tapfuma J.', rating: 4.8, trips: 142, 
        loyalty: 'Platinum', behavior: 'Frequent Rider', activeRequests: ['Ride Hailing', 'Food Delivery'], 
        topVertical: 'Ride Hailing', phone: '+263 771 999 888', email: 'tapfuma.j@example.com',
        joinDate: '12 Jan 2023', status: 'Active', totalSpend: 1250.40, walletBalance: 45.20,
        preferredVertical: 'Ride Hailing', lastOrderDate: '2 hours ago'
    },
    { 
        id: 'UP-002', lat: -17.824, lng: 31.054, name: 'Nyasha C.', rating: 4.9, trips: 89, 
        loyalty: 'Gold', behavior: 'Business User', activeRequests: ['Ride Hailing'], 
        topVertical: 'Ride Hailing', phone: '+263 772 111 222', email: 'nyasha.c@example.com',
        joinDate: '05 Mar 2023', status: 'Active', totalSpend: 890.15, walletBalance: 12.00,
        preferredVertical: 'Ride Hailing', lastOrderDate: '1 day ago'
    },
    { 
        id: 'UP-003', lat: -17.826, lng: 31.051, name: 'Kudzai L.', rating: 4.7, trips: 215, 
        loyalty: 'Platinum', behavior: 'Premium User', activeRequests: ['Food Delivery', 'Mart Delivery'], 
        topVertical: 'Food Delivery', phone: '+263 773 333 444', email: 'kudzai.l@example.com',
        joinDate: '10 Nov 2022', status: 'Active', totalSpend: 3120.00, walletBalance: 150.00,
        preferredVertical: 'Food Delivery', lastOrderDate: '30 mins ago'
    },
    { 
        id: 'UP-004', lat: -17.781, lng: 31.001, name: 'Rutendo M.', rating: 4.6, trips: 34, 
        loyalty: 'Silver', behavior: 'Weekend User', activeRequests: ['Parcel Delivery'], 
        topVertical: 'Parcel Delivery', phone: '+263 774 555 666', email: 'rutendo.m@example.com',
        joinDate: '15 Aug 2023', status: 'Active', totalSpend: 245.50, walletBalance: 0.00,
        preferredVertical: 'Ride Hailing', lastOrderDate: '3 days ago'
    },
];
