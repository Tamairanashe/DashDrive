                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1 mt-1">
                          {res.cuisineTypes?.map(type => (
                            <span key={type} className="px-1.5 py-0.5 bg-slate-50 text-slate-400 text-[8px] font-bold rounded-md border border-slate-100">{type}</span>
                          ))}
                          {!res.cuisineTypes?.length && <p className="text-[10px] text-slate-400 font-bold font-small-caps ">Owner: {res.owner}</p>}
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-8 py-6">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-sm font-bold text-slate-800">{res.rating?.toFixed(1) || '0.0'}</span>
                        <span className="text-[10px] text-slate-300 font-bold">({res.reviewCount || 0})</span>
                      </div>
                      <div className="flex items-center gap-1.5 mt-1">
                        <Clock className="w-3 h-3 text-slate-400" />
                        <span className="text-[10px] text-slate-400 font-bold font-small-caps">{res.estimatedPrepTime || 20} min prep</span>
                      </div>
                    </div>
                  </td>
                  <td className="px-8 py-6">
