    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button className="flex items-center gap-2.5 px-8 py-3 bg-slate-900 text-white rounded-2xl text-[11px] font-bold font-small-caps tracking-widest shadow-xl shadow-slate-900/10 hover:scale-105 active:scale-95 transition-all">
            ...
            <div className="bg-white rounded-[40px] p-10 shadow-soft border border-slate-100/50 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden group">
                ...
                <div className="w-48 h-48 rounded-[32px] bg-slate-900 flex flex-col items-center justify-center text-center p-6 shadow-2xl relative z-10 shrink-0">
                    <p className="text-[10px] font-bold text-primary uppercase tracking-[0.2em] mb-2 leading-none font-small-caps">Global Formula</p>
                    <div className="text-white space-y-1">
                        <p className="text-2xl font-display font-black tracking-tight">Base + (KM × Rate)</p>
                        <p className="text-[9px] font-bold text-white/40 uppercase tracking-widest">+ Surcharges</p>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-[40px] shadow-soft border border-slate-100/50 overflow-hidden">
                <div className="p-8 border-b border-slate-50 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest">Pricing Slabs</h4>
                    </div>
