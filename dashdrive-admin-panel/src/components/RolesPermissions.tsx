...
export const RolesPermissions: React.FC<RolesPermissionsProps> = ({ activeTab: externalTab }) => {
 ...
 <span className="text-[10px] font-bold text-slate-400 ">{role.members} Members</span>
 <span className="w-1 h-1 rounded-full bg-slate-200" />
 <span className="text-[10px] font-black text-[#0089D1] ">{role.permissions || 0} Rules</span>
 </div>
 </div>
 </div>
 <div className="flex items-center gap-6">
 ...
 <button className="w-full mt-10 py-5 bg-white/10 hover:bg-white/20 rounded-[28px] text-xs font-black transition-all border border-white/5">Modify Matrix</button>
 </div>
 </div>
 </div>
 );
 ...
 <span className="text-[10px] font-medium text-slate-400 tracking-[0.2em]">Security</span>
 <ChevronRight className="w-3 h-3 text-slate-300" />
 <span className="text-[10px] font-medium text-slate-400 tracking-[0.2em]">RBAC</span>
 </div>
 ...
 <div className="flex items-center gap-4">
 <button className="flex items-center gap-3 px-10 py-4 bg-white border border-slate-200 text-slate-400 rounded-[24px] text-xs font-black hover:bg-slate-50 hover:text-slate-600 transition-all">
