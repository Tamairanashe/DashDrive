          ...
          <div className="flex items-center gap-1.5 p-1 bg-slate-100/50 rounded-xl border border-slate-200/50">
            {[
              ...
              <button
                ...
                className={cn(
                  "px-4 py-2 text-[11px] font-bold rounded-lg transition-all duration-200 whitespace-nowrap",
                  activeTab === tab.id
                    ? "bg-[#00A89D] text-white shadow-lg shadow-teal-500/25"
              ...
              <div className="flex items-center justify-between gap-6">
                <div className="flex items-center gap-5">
                  ...
                  <div className="space-y-1">
                    <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest pl-0.5">Service</label>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="space-y-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest pl-0.5">Mode</label>
                      <div className="relative group">
                        <select
                          value={compareMode}
                    ...
                    {compareMode === 'Time vs Time' && (
                      <div className="space-y-1">
                        <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest pl-0.5">Date Range</label>
                        <div className="relative group">
                          <select
                            value={dateRange}
                ...
                <div className="flex items-center gap-6">
                  {/* Heat Mode Selector */}
                  <div className="space-y-1">
                    <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest pl-0.5">Heat mode</label>
              ...
              {[
                ...
                <div key={m.id} className="flex-1 rounded-[32px] border border-slate-200/60 shadow-soft overflow-hidden relative group">
                    ...
                    <div className="bg-slate-900/90 backdrop-blur-md rounded-2xl border border-white/10 p-4 shadow-2xl space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Ops status</span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                        <div>
                          ...
                          <p className="text-[8px] font-bold text-slate-500 uppercase mt-1">Trips</p>
                        </div>
                        <div>
                          <p className="text-[14px] font-bold text-white leading-none">{m.stats.drivers}</p>
                          <p className="text-[8px] font-bold text-slate-500 uppercase mt-1">Agents</p>
                        </div>
                        <div className="col-span-1 pt-1 border-t border-white/5">
                          ...
                          <p className="text-[8px] font-bold text-slate-500 uppercase mt-1">ETA</p>
                        </div>
                        <div className="col-span-1 pt-1 border-t border-white/5">
                          <p className="text-[12px] font-bold text-white leading-none">{m.stats.revenue}</p>
                          <p className="text-[8px] font-bold text-slate-500 uppercase mt-1">Rev</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-5 right-5 z-[1000] bg-white/90 backdrop-blur-md p-3 rounded-2xl border border-slate-200/50 shadow-lg">
                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2">Ops Legend</p>
                  ...
                  {compareMode !== 'Zone vs Zone' && (
                    <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-[1000]">
                      <div className="bg-white/80 backdrop-blur-md px-3 py-1 rounded-full border border-slate-200/50 shadow-sm flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Synced Camera</span>
                      </div>
                    </div>
                  )}
                </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-primary uppercase tracking-widest mt-1">AI Usage Analysis</p>
                    </div>
                  </div>
              ...
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-1">Global Variance</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-1">Order Shift</p>
                  </div>
                </div>
                <div className="h-8 w-px bg-white/5" />
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-1">Agent Density</p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              >
                ...
                <div className="absolute top-4 left-4 z-[1000] flex flex-col gap-1.5 grayscale-[0.2]">
                  ...
                  <button
                    onClick={() => setHeatMode('SupplyDemand')}
                    className={cn(
                      "w-8 h-8 flex items-center justify-center rounded-lg shadow-lg border transition-all active:scale-95",
                      heatMode === 'SupplyDemand' ? "bg-primary text-white border-primary" : "bg-white text-slate-500 border-slate-100 hover:text-primary"
                    )}
                ...
                <div className="absolute top-6 right-6 z-[1000]">
                  <div className="bg-white/80 backdrop-blur-md shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] rounded-[28px] border border-white/50 p-5 w-64">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Live status</h4>
