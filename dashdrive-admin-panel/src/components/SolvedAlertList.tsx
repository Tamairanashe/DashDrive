                ...
                {selectedAlert && (
                    <div className="mt-4 space-y-6">
                        <div className="grid grid-cols-2 gap-4 bg-zinc-50 p-4 rounded-xl border border-zinc-100">
                            <div>
                                <Text type="secondary" className="text-xs uppercase font-bold tracking-wider">Alert Type</Text>
                                <div className="mt-1 font-medium">{selectedAlert.type.replace('_', ' ')}</div>
                            </div>
                            <div>
                                <Text type="secondary" className="text-xs uppercase font-bold tracking-wider">Severity</Text>
                            ...
                            <div>
                                <Text type="secondary" className="text-xs uppercase font-bold tracking-wider">Triggered At</Text>
                                <div className="mt-1 text-sm">{new Date(selectedAlert.triggerTime).toLocaleString()}</div>
                            </div>
                            <div>
                                <Text type="secondary" className="text-xs uppercase font-bold tracking-wider">Resolved At</Text>
                                <div className="mt-1 text-sm">{new Date(selectedAlert.resolutionTime).toLocaleString()}</div>
                            </div>
                        </div>

                        <div>
                            <Text type="secondary" className="text-xs uppercase font-bold tracking-wider block mb-2 text-zinc-400">Initial Description</Text>
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <Text type="secondary" className="text-xs uppercase font-bold tracking-wider text-green-600">Resolution Log</Text>
                            </div>
