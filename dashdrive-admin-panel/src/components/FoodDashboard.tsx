...
export const FoodDashboard: React.FC = () => {
 ...
 <span className="text-[10px] font-bold text-slate-600 font-small-caps ">Analyzing 1,240 Current Reqs</span>
 </div>
 </div>
 </div>
 ...
 <span className="text-[9px] font-bold text-slate-400 font-small-caps ">Total Active</span>
 </div>
 </div>
 ...
 <span className="text-[10px] font-bold text-slate-500 font-small-caps ">{s.name} ({s.value})</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <button className="w-full mt-8 py-3 bg-white/5 hover:bg-white/10 text-white/60 rounded-xl text-[10px] font-bold font-small-caps border border-white/10 transition-all ">
