...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const [expandedItems, setExpandedItems] = useState<string[]>(['SERVICES', 'OPERATIONS', 'FINANCE', 'Ride Hailing', 'Food Delivery']);
  ...
  const navGroups: { group: string; items: NavItem[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          icon: ShoppingCart,
          label: 'Shopping',
          subItems: ['Shopping Dashboard', 'Shopping Products', 'Shopping Categories', 'Shopping Orders', 'Vendors / Merchants', 'Reviews & Ratings']
        },
        {
          icon: Box,
        ...
        { icon: Globe, label: 'Marketplace & Stays' },
        { icon: Ticket, label: 'Events Booking' },
        { icon: Key, label: 'Car Rental' },
        { icon: Compass, label: 'City to City' },
        { icon: Backpack, label: 'School Run Monitor' }
      ]
    },
    {
      group: 'PARTNERS & FLEET',
      items: [
        { icon: UserCheck, label: 'Drivers' },
        { icon: Bike, label: 'Couriers' },
        { icon: Building, label: 'Fleet Operators' },
        { icon: Layers, label: 'Vehicle Management' }
      ]
    },
    {
      group: 'USERS',
    ...
    },
    {
      group: 'OPERATIONS',
      items: [
        { icon: GanttChart, label: 'Operations Hub' },
        { icon: MapPin, label: 'Zone Setup' },
        { icon: Zap, label: 'Dispatch Management' },
        { icon: History, label: 'Live Tracking' },
        { icon: AlertCircle, label: 'Active Alerts' },
        { icon: TrendingUp, label: 'Surge Control' },
        { icon: FileText, label: 'History Logs' }
      ]
    },
    {
      group: 'ANALYTICS & PERFORMANCE',
      items: [
        { icon: BarChartHorizontal, label: 'Performance Analytics' },
    ...
    },
    {
      group: 'FINANCE',
      items: [
        { icon: DollarSign, label: 'Fare Management' },
        { icon: BarChart3, label: 'Financial Reports Hub' },
        { icon: Wallet, label: 'Settlement & Payouts' },
        { icon: CreditCard, label: 'Fintech Partner Hub' }
      ]
    },
    {
      ...
      items: [
        ...
        { icon: Rocket, label: 'Growth Engine' }
      ]
    },
    {
      group: 'MARKETPLACE & INTEGRATIONS',
      items: [
        { icon: ShoppingBag, label: 'Product Marketplace' },
        { icon: Layers, label: 'Utility Aggregator' }
      ]
    },
    {
      group: 'CONTENT',
    ...
    },
    {
      ...
      items: [
        ...
        { icon: MessageSquare, label: 'Partner Feedback' },
        { icon: ShieldAlertIcon, label: 'Moderation Queue' },
        { icon: Shield, label: 'Reputation Analytics' }
      ]
    },
    {
      group: 'SUPPORT',
      items: [
        { icon: LifeBuoy, label: 'Support Hub' },
        { icon: Wrench, label: 'Technical Resolution' }
      ]
    },
    {
      group: 'ENTERPRISE',
      items: [
        { icon: Building2, label: 'Enterprise Business Setup' },
        { icon: Settings2, label: 'Configuration' },
        { icon: FileSearch, label: 'Audit Logs' },
        { icon: Lock, label: 'Access & Governance' },
        { icon: Code2, label: 'API Management' },
