const API_BASE_URL = (import.meta.env.VITE_API_URL || import.meta.env.VITE_BACKEND_URL || 'http://localhost:8000') + '/api/v1';
...
export const api = {
    ...
    merchants: {
        getProfile: (token: string) => fetchFromAdmin('/merchants/profile', {
