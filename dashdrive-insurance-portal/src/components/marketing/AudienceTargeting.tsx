...
export function AudienceTargeting({ token }: { token: string }) {
    ...
    const [segments, setSegments] = useState([
        { id: 'SEG-001', name: 'High Earning Drivers', city: 'Lagos', tier: 'Diamond', earnings: '> $2000', rating: '4.8+', size: '1,240', status: 'Active' },
        { id: 'SEG-002', name: 'New Joiners', city: 'All Cities', tier: 'Blue', earnings: 'N/A', rating: 'N/A', size: '5,800', status: 'Active' },
        { id: 'SEG-003', name: 'Elite Customer Base', city: 'Port Harcourt', tier: 'Platinum', earnings: '> $3500', rating: '4.9+', size: '840', status: 'Active' },
    ]);
        ...
        },
        {
            ...
            render: (_: any, record: any) => (
                <Space wrap>
                    ...
                    <Tag icon={<Award size={12} />}>{record.tier}</Tag>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    ...
                    <Text type="secondary">Define and manage specific user segments for your promotional campaigns.</Text>
                </div>
            ...
            <Row gutter={24}>
                <Col span={6}>
                    <Card style={{ borderRadius: '16px' }} bodyStyle={{ padding: '20px' }}>
                        <Statistic title="Total Reachable Audience" value="124,500" prefix={<Users size={20} />} valueStyle={{ fontWeight: 800 }} />
                    </Card>
                </Col>
                <Col span={6}>
                    <Card style={{ borderRadius: '16px' }} bodyStyle={{ padding: '20px' }}>
            ...
            >
                <Form layout="vertical">
                    <Form.Item label="Segment Name" required>
                        <Input placeholder="e.g., High Earning Lagos Drivers" />
                    </Form.Item>
                    ...
                    <Form.Item label="City">
                        <Select mode="multiple" placeholder="Select cities">
                            ...
                            <Select.Option value="ph">Port Harcourt</Select.Option>
                    ...
                    <Form.Item label="Past Purchases / History">
                        <Select mode="multiple" placeholder="Select criteria">
                            <Select.Option value="life">Has Life Insurance</Select.Option>
                            <Select.Option value="auto">Has Auto Insurance</Select.Option>
                            <Select.Option value="claim">No Claims in 1 Year</Select.Option>
                        </Select>
                    </Form.Item>
                    ...
                    <Card style={{ backgroundColor: '#f8fafc', borderRadius: '12px', border: 'none' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Title level={5} style={{ margin: 0, color: '#3b82f6' }}>~ 2,450 users</Title>
                        </div>
                    </Card>
                </Form>
            </Drawer>
