...
export const DriverManagementHub: React.FC = () => {
  ...
  const seedMockData = () => {
    const newDrivers = [
      { 
        id: 'DR-9901', name: 'James Makoni', email: 'j.makoni@dashdrive.com', phone: '+263 772 111 222', vehicle: 'Toyota Corolla', rating: 4.8, status: 'Active', city: 'Harare', category: 'Economy', walletBalance: 450.00, isFrozen: false, 
        trips: 125, cancellationRate: '0.8%', acceptanceRate: '99%', joinDate: '10 Feb 2024', tier: 'Gold',
        services: ['Ride Request'],
        avgActiveRate: '92%', avgEarningValue: 65.00, positiveReviewRate: '98%', successRate: '99%', todayIdleHourRate: '0.5h',
        collectableCash: 0, pendingWithdraw: 150.00, alreadyWithdrawn: 3000.00, withdrawableAmount: 450.00, totalEarning: 3600.00,
        completedTrips: 124, cancelledTrips: 1, lowestPriceTrip: 5.20, highestPriceTrip: 85.00,
        idDocuments: ['doc_9901_id.png'], otherDocuments: []
      },
      { 
        id: 'DR-9902', name: 'Tendai Moyo', email: 't.moyo@dashdrive.com', phone: '+263 773 333 444', vehicle: 'Nissan X-Trail', rating: 4.2, status: 'Offline', city: 'Bulawayo', category: 'Premium', walletBalance: -12.50, isFrozen: true, 
        trips: 45, cancellationRate: '15%', acceptanceRate: '80%', joinDate: '15 Mar 2024', tier: 'Silver',
        services: ['Ride Request', 'Delivery'],
        avgActiveRate: '45%', avgEarningValue: 42.00, positiveReviewRate: '88%', successRate: '85%', todayIdleHourRate: '4h',
        collectableCash: 12.50, pendingWithdraw: 0, alreadyWithdrawn: 500.00, withdrawableAmount: 0, totalEarning: 487.50,
        completedTrips: 38, cancelledTrips: 7, lowestPriceTrip: 12.00, highestPriceTrip: 45.00,
        idDocuments: ['doc_9902_id.png'], otherDocuments: []
      },
      { 
        id: 'DR-9903', name: 'Blessing Zulu', email: 'b.zulu@dashdrive.com', phone: '+263 712 555 666', vehicle: 'VW Golf', rating: 4.9, status: 'Active', city: 'Harare', category: 'Premium', walletBalance: 1240.20, isFrozen: false, 
        trips: 2100, cancellationRate: '0.2%', acceptanceRate: '100%', joinDate: '01 Jan 2022', tier: 'Platinum',
        services: ['Ride Request', 'Premium VVIP'],
        avgActiveRate: '98%', avgEarningValue: 120.00, positiveReviewRate: '99%', successRate: '99.8%', todayIdleHourRate: '0.2h',
        collectableCash: 0, pendingWithdraw: 500.00, alreadyWithdrawn: 45000.00, withdrawableAmount: 1240.20, totalEarning: 46740.20,
        completedTrips: 2095, cancelledTrips: 5, lowestPriceTrip: 15.00, highestPriceTrip: 350.00,
        idDocuments: ['platinum_id.png'], otherDocuments: ['insurance_v2.pdf']
      }
    ];
    setDrivers(prev => [...prev, ...newDrivers]);
    message.success(`${newDrivers.length} high-fidelity mock drivers seeded successfully`);
  };
    ...
    <div style={{ padding: '24px', background: '#f8fafc', minHeight: '100vh' }}>
      <div style={{ marginBottom: 24 }}>
        <Row justify="space-between" align="middle">
          ...
          <Col>
            <Space>
               <Button icon={<ThunderboltOutlined />} onClick={seedMockData} style={{ color: '#8b5cf6', borderColor: '#8b5cf6' }}>Seed Mocks</Button>
