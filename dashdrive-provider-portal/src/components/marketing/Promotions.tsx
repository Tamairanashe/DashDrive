...
export function Promotions({ token }: { token: string }) {
    const [title, setTitle] = useState('Credit Line Increase');
    const [message, setMessage] = useState('Great news! You are eligible for a $5,000 credit limit increase. Tap to accept now.');
        ...
        <Row gutter={[48, 48]}>
            <Col xs={24} lg={12}>
                <div style={{ marginBottom: '32px' }}>
                    ...
                    <Text type="secondary">Reach your borrowers directly via mobile push notifications</Text>
                </div>

                <Row gutter={16} style={{ marginBottom: '24px' }}>
                    {[
                        { label: 'Total Sent', value: '38.5k', color: '#3b82f6' },
                        { label: 'Opened', value: '12.2k', color: '#10b981' },
                        { label: 'Applications', value: '3.4k', color: '#f59e0b' },
                    ].map((stat, i) => (
                        <Col span={8} key={i}>
                    ...
                    <Space direction="vertical" size="large" style={{ width: '100%' }}>
                        <div>
                            ...
                            <Input
                                ...
                                placeholder="e.g. Asset Finance Special"
                        ...
                        <Row gutter={16}>
                            <Col span={12}>
                                ...
                                <Select
                                    ...
                                    style={{ width: '100%' }}
                                    options={[
                                        { value: 'All Customers', label: 'All Borrowers' },
                                        { value: 'Recent Customers', label: 'Pending Applications' },
                                        { value: 'High Spenders', label: 'VIP Borrowers' },
                                    ]}
                                />
                            </Col>
                            <Col span={12}>
