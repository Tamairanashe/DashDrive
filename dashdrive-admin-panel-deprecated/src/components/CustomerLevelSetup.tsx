...
export function CustomerLevelSetup() {
 ...
 <Divider><span className="text-xs text-zinc-400 font-bold ">Unlocking Requirements</span></Divider>
 ...
 <Divider><span className="text-xs text-zinc-400 font-bold ">Configuration</span></Divider>
